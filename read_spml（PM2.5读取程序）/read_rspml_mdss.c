...
#define  FDATANUM  1000000   //从数据库中返回的整型数据总数：record_num*column_float_num。abwa有32个实型字段：45×400000=28400000
...
/*--- 4. 设置输出文件  ---*/
    sprintf(output,  "%s/spml_data/spml_%s_%s.dat", getenv("HOME"),argv[1],argv[2]);
     printf("fengyuxing7\n");
