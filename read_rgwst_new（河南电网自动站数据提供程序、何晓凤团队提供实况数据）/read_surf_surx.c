...
#define  CDATANUM  4000   ////从数据库中返回的字符型数据总数：record_num*column_char_num。abwa没有字符型数据 28×400000=
#define  IDENNUM   100000   //long ciden[],fiden[]数组大小：从数据库中返回的记录总数。一个站一年有12*3条记录。假设有10000个站：12×3×10000=360000
...
/*--- 1. 字符型输入参数数组 cpar ---*/
    ...
    */
    strcpy(cpar[3],"NULL");
    strcpy(cpar[4],"V01000,V05001,V06001,V07001,V12001,V13003,V11001,V11002,V13021,V13023,V20010,V20011,V12016,V12017,V20003,V10004,V12003,V20001,V13019,V13020,V13022,V12014,V12015,V10060_024,V13031,V20004,V20005,V20013,V20012_011,V20012_012,V20012_013,V20012_001,V20012_002,V20012_003,V20012_004,V20062");

   // strcpy(cpar[3],"ALL");
   // strcpy(cpar[4],"V01000,V04001,V04002,V04003,V_OHM,V05001,V06001,V07001,V02001,V10004,V10051,V11001,V11002,V12001,V12003,V13003,V20001,V20003,V20010,V13019,V13020,V13021,V13022,V13023,V13013,V14032,V14202");
    ...
    */
    ...
    //strcpy(cpar[16],"V04001=2016  and V04002=6 and  V04003=6 and V_OHM=0000");
    strcpy(cpar[16],"NULL");
    strcpy(cpar[17],"EOF");
...
/*--- 4. 设置输出文件  ---*/
    sprintf(output, "%s/data/rgwst_new_data/obs%s%s.dat", getenv("HOME"),argv[1],argv[4]);
     printf("fengyuxing7\n");

       ret = elemsea(1101, cpar, lpar, cdata, fdata, ciden, fiden);
       printf("fengyuxing8\n");
...
int OutPut(char filename[],long fiden[],long ciden[],float fdata[],char cdata[][CF_LEN])
{
    ...
    {
			for(j=0; j<fiden[i+4]; j++) //每条记录字符型数据总个数
			{
