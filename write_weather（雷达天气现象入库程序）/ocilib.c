...
**
**********************************************************************/
int insert_weather(char *name,char *bjtime,char *source,char *weather,char *update,float value[])
{
    ...
    */
    ...
    sprintf(select_statement,"select count(*) as num from base.ele_radar_weather where stationid = :1  and  bjtime = :3");
   // printf("fengyxuing2\n");
    ...
    status |= OCIBindByPos(stmthp1, &bnd2hp, errhp, 2,
                           (dvoid *)bjtime, strlen(bjtime)+1, SQLT_STR,
                           (dvoid *) 0, (ub2 *) 0, (ub2 *) 0,
                           (ub4) 0, (ub4 *) 0, (ub4) OCI_DEFAULT);
    ...
    */
    if(ret>0)
    {
     // printf("fengyxuing4\n");
      ...
      sprintf(delete_statement,"delete  from base.ele_radar_weather where stationid = :1  and  bjtime = :3");
      // printf("%s\n",delete_statement);
   ...
   // printf("fengyxuing6\n");
    ...
    sprintf(insert_statement, "insert into base.ele_radar_weather values(:1,:2,:3,:4,:5,:6)");
   // printf("%s\n",insert_statement);
   // printf("fengyxuing7\n");
     ...
     status = OCIStmtPrepare(stmthp, errhp, 
      ...
      status |= OCIBindByPos(stmthp, &bnd2hp, errhp, 2,
                           (dvoid *)name, strlen(name)+1, SQLT_STR,
                           (dvoid *) 0, (ub2 *) 0, (ub2 *) 0,
                           (ub4) 0, (ub4 *) 0, (ub4) OCI_DEFAULT);
      ...
      status |= OCIBindByPos(stmthp, &bnd4hp, errhp, 4,
                           (dvoid *)source, strlen(source)+1, SQLT_STR,
                           (dvoid *) 0, (ub2 *) 0, (ub2 *) 0,
                           (ub4) 0, (ub4 *) 0, (ub4) OCI_DEFAULT);
      status |= OCIBindByPos(stmthp, &bnd5hp, errhp, 5,
                           (dvoid *)weather, strlen(weather)+1, SQLT_STR,
                           (dvoid *) 0, (ub2 *) 0, (ub2 *) 0,
                           (ub4) 0, (ub4 *) 0, (ub4) OCI_DEFAULT);
      status |= OCIBindByPos(stmthp, &bnd6hp, errhp, 6,
                           (dvoid *)update, strlen(update)+1, SQLT_STR,
                           (dvoid *) 0, (ub2 *) 0, (ub2 *) 0,
                           (ub4) 0, (ub4 *) 0, (ub4) OCI_DEFAULT);
