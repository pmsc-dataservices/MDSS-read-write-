...
#define  FDATANUM  5000000   //从数据库中返回的整型数据总数：record_num*column_float_num。abwa有32个实型字段：71×400000=28400000
#define  CDATANUM  4000000   ////从数据库中返回的字符型数据总数：record_num*column_char_num。abwa没有字符型数据 28×400000=
...
/*--- 1. 字符型输入参数数组 cpar ---*/
    ...
    */
    strcpy(cpar[3],"NULL");
    strcpy(cpar[4],"V01000,V04001,V04002,V04003,V_OHM,V20011,V12001,V11001,V11002,V13023,V13003,V20003,V10004,V12016,V12017,V13021,V20010,V10051,V12003,V14032,V14202,V05001,V06001,V07001,V20001,V13019,V13020,V13022,V13013,V20012_011");
...
/*--- 4. 设置输出文件  ---*/
    sprintf(output, "%s/data/surf_awst_151/surf_%s_%s_%s.dat", getenv("HOME"),argv[1],argv[2],argv[3]);
     printf("fengyuxing7\n");
