...
/*--- 1. 字符型输入参数数组 cpar ---*/
    ...
    */
    strcpy(cpar[3],"NULL");
    strcpy(cpar[4],"V01000,V04001,V04002,V04003,V04004,V04005,V04006,V20011,V12001,V11001,V11002,V13023,V13003,V20003,V10004,V12016,V12017,V13019,V20010,V12013,V20001,V11043,V11041,V13021,V11001_002,V11002_002,V12003,V20012_011,V05001,V06001,V07001,V20001_052,V11202_010,V11042_010");
   // strcpy(cpar[3],"ALL");
...
/*--- 4. 设置输出文件  ---*/
    sprintf(output,  "%s/data/surf_awst_151/awst_%s_%s.txt", getenv("HOME"),argv[1],argv[2]);
