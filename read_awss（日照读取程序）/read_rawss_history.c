...
#define  FDATANUM  150000000   //从数据库中返回的整型数据总数：record_num*column_float_num。abwa有32个实型字段：71×400000=28400000
#define  CDATANUM  5000000   ////从数据库中返回的字符型数据总数：record_num*column_char_num。abwa没有字符型数据 28×400000=
#define  IDENNUM   5000000   //long ciden[],fiden[]数组大小：从数据库中返回的记录总数。一个站一年有12*3条记录。假设有10000个站：12×3×10000=360000
...
/*--- 1. 字符型输入参数数组 cpar ---*/
    ...
    */
       strcpy(cpar[3],"NULL");
       strcpy(cpar[4],"V01000,V04001,V04002,V04003,V04004,V04005,V04006,V05001,V06001,V14032_001,V14032_002,V14032_003,V14032_004,V14032_005,V14032_006,V14032_007,V14032_008,V14032_009,V14032_010,V14032_011,V14032_012,V14032_013,V14032_014,V14032_015,V14032_016,V14032_017,V14032_018,V14032_019,V14032_020,V14032_021,V14032_022,V14032_023,V14032_024,V14032");
...
/*--- 2. 长整型输入参数数组lpar ---*/
    ...
    */
    ...
    printf("fengyuxing4\n");
	  ...
	  /* 
	  ----- 检索区域的设置：lpar[11-31]
	  ----- lpar[11]：设置区域检索条件, 0表示检索所有区域的数据; 1表示检索某个经纬度范围的数据; 2表示检索某区站号范围的数据; 3表示检索某些区站号的数据; 4表示检索某些国家或者中国某些省的资料
	  */
    ...
    /*
    ----- 作物检索参数的设置：lpar[40-60]
    ----- lpar[40] ：设置作物名称的检索方式, 0表示检索所有作物的资料（Lpar[41]以后的参数无需设置）; 2表示检索某些指定作物的资料
    */
    //lpar[40] = 0;
    
    /* 
    ----- lpar 数组结束标记设置 :lpar[61]
    */
   // lpar[61] = -999999;
...
/*--- 4. 设置输出文件  ---*/
    sprintf(output, "%s/data/awss_data/awss_%s_%s.dat", getenv("HOME"),argv[1],argv[2]);
     printf("fengyuxing7\n");
